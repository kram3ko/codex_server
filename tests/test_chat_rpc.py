from app.rpc.chat.mappers import final_text_for_done_frame
...
def test_done_frame_omits_final_text_when_it_matches_streamed_text() -> None:
    ...
    assert final_text_for_done_frame("готово", "готово") == ""
...
def test_done_frame_keeps_final_text_when_it_differs_from_streamed_text() -> None:
    ...
    assert final_text_for_done_frame("готово додатковий рядок", "готово") == (
...
def test_done_frame_keeps_final_text_when_streamed_was_empty() -> None:
    ...
    assert final_text_for_done_frame("повний результат", "") == "повний результат"
