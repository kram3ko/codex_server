...
class ChatEvent(_message.Message):
    __slots__ = ("token", "tool_call", "tool_result", "done", "error", "turn_started", "event_id")
    ...
    event_id: str
    def __init__(self, token: _Optional[_Union[TokenEvent, _Mapping]] = ..., tool_call: _Optional[_Union[ToolCallEvent, _Mapping]] = ..., tool_result: _Optional[_Union[ToolResultEvent, _Mapping]] = ..., done: _Optional[_Union[DoneEvent, _Mapping]] = ..., error: _Optional[_Union[ErrorEvent, _Mapping]] = ..., turn_started: _Optional[_Union[TurnStartedEvent, _Mapping]] = ..., event_id: _Optional[str] = ...) -> None: ...

class TurnStartedEvent(_message.Message):
    __slots__ = ("turn_id",)
...
class TailTurnRequest(_message.Message):
    __slots__ = ("chat_id", "after_id", "turn_id")
    CHAT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    after_id: str
    turn_id: int
    def __init__(self, chat_id: _Optional[int] = ..., after_id: _Optional[str] = ..., turn_id: _Optional[int] = ...) -> None: ...
