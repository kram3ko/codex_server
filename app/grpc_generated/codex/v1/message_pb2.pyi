...
class ListMessagesRequest(_message.Message):
    __slots__ = ("chat_id", "pagination", "before_id")
    CHAT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    before_id: int
    def __init__(self, chat_id: _Optional[int] = ..., pagination: _Optional[_Union[_common_pb2.Pagination, _Mapping]] = ..., before_id: _Optional[int] = ...) -> None: ...
